...
VALUES ('0000', 'Brendan', 'Muldoon', '5', 'Foxton Place', 'BT365FS', 'Staff', 'brendy', 'password');

INSERT INTO staff_skills(skill_id, strength_of_skill, expiry, staff_id)
VALUES ('1111-1111-1111-1111', 'Basic', '2022-12-31', '0000'),
       ('2222-2222-2222-2222', 'Intermediate', '2022-12-31', '0000'),
       ('1111-2222-3333-4444', 'Advanced', '2022-12-31', '0000');
